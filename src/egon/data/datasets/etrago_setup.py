...
class EgonPfHvBus(Base):
    ...
    v_nom = Column(Float(53), default=1.)
    type = Column(Text)
    carrier = Column(Text)
    v_mag_pu_set_fixed = Column(Float(53), default=1.)
    v_mag_pu_min = Column(Float(53), default=0.)
    v_mag_pu_max = Column(Float(53), default='inf')
    x = Column(Float(53),default=0.)
    y = Column(Float(53),default=0.)
...
class EgonPfHvGenerator(Base):
    ...
    p_min_pu_fixed = Column(Float(53), default=0.)
    p_max_pu_fixed = Column(Float(53), default=1.)
    p_set_fixed = Column(Float(53), default=0.)
    q_set_fixed = Column(Float(53), default=0.)
    sign = Column(Float(53),default=1)
    marginal_cost_fixed = Column(Float(53),default=0.)
    capital_cost = Column(Float(53),default=0.)
    efficiency = Column(Float(53),default=1.)
    committable = Column(Boolean,default=False)
    start_up_cost = Column(Float(53),default=0.)
    shut_down_cost = Column(Float(53),default=0.)
    min_up_time = Column(BigInteger,default=0)
    min_down_time = Column(BigInteger,default=0)
    up_time_before = Column(BigInteger,default=0)
    down_time_before = Column(BigInteger,default=0)
    ramp_limit_up = Column(Float(53),default='NaN')
    ramp_limit_down = Column(Float(53),default='NaN')
    ramp_limit_start_up = Column(Float(53),default=1)
    ramp_limit_shut_down = Column(Float(53),default=1)
...
class EgonPfHvStorage(Base):
    ...
    type = Column(Text)
    carrier = Column(Text)
    p_nom = Column(Float(53), default=0.)
    p_nom_extendable = Column(Boolean)
    p_nom_min = Column(Float(53), default=0.)
    p_nom_max = Column(Float(53))
    p_min_pu_fixed = Column(Float(53), default=-1.)
    p_max_pu_fixed = Column(Float(53), default=1.)
    p_set_fixed = Column(Float(53), default=0.)
    q_set_fixed = Column(Float(53), default=0.)
    sign = Column(Float(53), default=1.)
    marginal_cost_fixed = Column(Float(53),default=0.)
    capital_cost = Column(Float(53), default=0.)
    state_of_charge_initial = Column(Float(53), default=0.)
    cyclic_state_of_charge = Column(Boolean)
    state_of_charge_set_fixed = Column(Float(53))
    max_hours = Column(Float(53), default=1.)
    efficiency_store = Column(Float(53), default=1.)
...
class EgonPfHvStore(Base):
    ...
    type = Column(Text)
    carrier = Column(Text)
    e_nom = Column(Float(53), default=0.)
    e_nom_extendable = Column((Boolean), default=False)
    e_nom_min = Column(Float(53), default=0.)
    e_nom_max = Column(Float(53), default='inf')
    e_min_pu_fixed = Column(Float(53), default=0.)
    e_max_pu_fixed = Column(Float(53), default=1.)
    p_set_fixed = Column(Float(53), default=0.)
    q_set_fixed = Column(Float(53), default=0.)
    e_initial = Column(Float(53), default=0.)
    e_cyclic = Column((Boolean), default=False)
    sign = Column(Float(53), default=1.)
    marginal_cost_fixed = Column(Float(53), default=0.)
    capital_cost = Column(Float(53), default=0.)
    standing_loss = Column(Float(53))
...
class EgonPfHvTransformer(Base):
    ...
    bus1 = Column(BigInteger)
    type = Column(Text)
    model = Column((Text), default="t")
    x = Column((Numeric), default=0.)
    r = Column((Numeric), default=0.)
    g = Column((Numeric), default=0.)
    b = Column((Numeric), default=0.)
    s_nom = Column(Float(53), default=0.)
    s_nom_extendable = Column((Boolean), default=False)
    s_nom_min = Column(Float(53), default=0.)
    s_nom_max = Column(Float(53), default='inf')
    s_max_pu_fixed = Column(Float(53), default=1.)
    tap_ratio = Column(Float(53), default=1.)
    tap_side = Column((BigInteger), default=0)
    tap_position = Column((BigInteger), default=0)
    phase_shift = Column(Float(53), default=0.)
    v_ang_min = Column(Float(53), default='-inf')
    v_ang_max = Column(Float(53), default='inf')
    capital_cost = Column(Float(53), default=0.)
    num_parallel = Column(Float(53), default=1.)
    geom = Column(Geometry("MULTILINESTRING", 4326))
    topo = Column(Geometry("LINESTRING", 4326))
