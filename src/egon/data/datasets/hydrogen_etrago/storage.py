...
def insert_H2_overground_storage(scn_name):
    """
...
def insert_H2_saltcavern_storage(scn_name):
    ...
    storages.rename(
        columns={
            "bus_H2": "bus",
            "summed_potential_per_bus": "e_nom_max",
        },
        inplace=True,
    )
