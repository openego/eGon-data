...
INSERT INTO demand.egon_building_peak_loads (cell_osm_ids, building_peak_load_in_kWh_2035,building_peak_load_in_kWh_2050 )
...
FROM (
	...
	FROM (
		...
		FROM (
			SELECT buildings.cell_osm_ids , profiles.load_in_wh , census.factor_2035 , census.factor_2050 FROM

				demand.egon_household_electricity_profile_in_census_cell AS census,
