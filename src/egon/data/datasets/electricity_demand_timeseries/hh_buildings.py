...
sufficient OSM-data available in the respective cencus cell.
...
* `demand.egon_household_electricity_profile_of_buildings`:
    Mapping of demand timeseries and buildings including cell_id,
    building area and peak load
...
profiles then buildings, all additional profiles are randomly assigned.
...
This module docstring is rather a dataset documentation. Once, a
decision is made in ... the content of this module docstring needs to be
