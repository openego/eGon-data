...
CH4) abroad for eGon2035, nep2037_2025 and eGon100RE are defined.
...
def insert_gas_grid_capacities(Neighbouring_pipe_capacities_list, scn_name):
    ...
    For eGon2035 and nep2037_2025, all the CH4 crossbordering pipelines are inserted
    (no H2 grid in this scenario).
    For eGon100RE and nep2037_2025, only the crossbordering pipelines with Germany
