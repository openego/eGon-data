"""Central module containing code dealing with gas neighbours for eGon100RE
"""
...
def define_DE_crossbording_pipes_geom_eGon100RE(scn_name="eGon100RE"):
    ...
    Returns
    -------
    gas_pipelines_list_DE : dataframe
...
def read_DE_crossbordering_cap_from_pes():
    """Read gas pipes crossbordering capacities from pes run
...
def calculate_crossbordering_gas_grid_capacities_eGon100RE(
    ...
    """Define gas crossbordering grid capacities for eGon100RE
