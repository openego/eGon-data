"""Central module containing code dealing with gas neighbours for nep2037_2025
"""
...
def calc_capacities():
    ...
    generation capacity in 2037 using the function
    ...
    df_2037 = pd.concat([df_2040, df_2030], axis=1)
    df_2037 = df_2037.drop(
        columns=[
            "Value_conv_2040",
            "Value_conv_2030",
            "Value_bio_2040",
    ...
    df_2037["cap_2037"] = (df_2037["CH4_2030"] + df_2037["CH4_2040"]) / 2
    df_2037["e_nom_max"] = (
        ((df_2037["e_nom_max_2030"] + df_2037["e_nom_max_2040"]) / 2)
        * conversion_factor
        * 8760
    )
    df_2037["share_LNG_2037"] = (
        df_2037["share_LNG_2030"] + df_2037["share_LNG_2040"]
    ) / 2
    df_2037["share_conv_pipe_2037"] = (
        df_2037["share_conv_pipe_2030"] + df_2037["share_conv_pipe_2040"]
    ) / 2
    df_2037["share_bio_2037"] = (
        df_2037["share_bio_2030"] + df_2037["share_bio_2040"]
    ) / 2

    grouped_capacities = df_2037.drop(
        columns=[
            "share_LNG_2030",
            "share_LNG_2040",
    ...
    grouped_capacities["cap_2037"] = (
        grouped_capacities["cap_2037"] * conversion_factor
    )
    ...
    df_conv_2037 = pd.concat([df_conv_2040, df_conv_2030], axis=1)

    df_conv_2037["cap_2037_2025"] = (
        (df_conv_2037["Value_2030"] + df_conv_2037["Value_2040"]) / 2
    ) * conversion_factor
    df_conv_2037["e_nom_max"] = df_conv_2037["cap_2037"] * 8760
    df_conv_2037["share_LNG_2037_2025"] = 0
    df_conv_2037["share_conv_pipe_2037_2025"] = 1
    df_conv_2037["share_bio_2037_2025"] = 0

    df_conv_2037 = df_conv_2037.drop(
        columns=[
            "Year",
            "Value_2030",
            "Value_2040",
    ...
    df_conv_2037 = df_conv_2037.rename(columns={"Node/Line": "index"})
    grouped_capacities = grouped_capacities.append(df_conv_2037)
...
def insert_generators(gen):
    ...
    scn_params = get_sector_parameters("gas", "nep2037_2025")
    ...
    # Add missing columns
    c = {"scn_name": "nep2037_2025", "carrier": "CH4"}
    gen = gen.assign(**c)

    new_id = db.next_etrago_id("generator")
    gen["generator_id"] = range(new_id, new_id + len(gen))
    gen["p_nom"] = gen["cap_2037_2025"]
    gen["marginal_cost"] = (
        gen["share_LNG_2037_2025"] * scn_params["marginal_cost"]["CH4"] * 1.3
        + gen["share_conv_pipe_2037_2025"] * scn_params["marginal_cost"]["CH4"]
        + gen["share_bio_2037_2025"] * scn_params["marginal_cost"]["biogas"]
    )
...
def calc_global_ch4_demand(Norway_global_demand_1y):
    """Calculates global CH4 demands abroad for nep2037_2025 scenario
    ...
    df_2037 = pd.concat([df_2040, df_2030], axis=1)
    df_2037["GlobD_2037_2025"] = (
        (df_2037["Value_2030"] + df_2037["Value_2040"]) / 2
    ) * conversion_factor
    df_2037.loc["NOS0"] = [
        0,
        0,
...
def insert_ch4_demand(global_demand, normalized_ch4_demandTS):
    """Insert CH4 demands abroad into the database for nep2037
    ...
    # Remove useless columns
    global_demand = global_demand.drop(columns=["Node/Line", "GlobD_2037_2025"])
    ...
    ch4_demand_TS = ch4_demand_TS.drop(
        columns=["Node/Line", "GlobD_2037_2025", "bus", "carrier"]
    )
...
def calc_ch4_storage_capacities():
    ...
    ch4_storage_capacities = ch4_storage_capacities[
        ch4_storage_capacities["end_year"] >= 2037
    ]
...
def insert_storage(ch4_storage_capacities):
    """Insert CH4 storage capacities into the database for nep2037_2025
...
def calc_global_power_to_h2_demand():
    """Calculate H2 demand abroad for nep2037_2025 scenario
    ...
    global_power_to_h2_demand = df_2037.drop(
        columns=["Value_2030", "Value_2040"]
    )
    ...
    global_power_to_h2_demand = global_power_to_h2_demand[
        ...
        & (global_power_to_h2_demand["GlobD_2037_2025"] != 0)
    ]
...
def insert_power_to_h2_demand(global_power_to_h2_demand):
    """Insert H2 demands into database for nep2037_2025
...
def calculate_ch4_grid_capacities():
    ...
    pipe_capacities_list = pipe_capacities_list[
        ["To Country", "Unnamed: 3", "From Country", 2037]
    ].rename(
        columns={
            "Unnamed: 3": "Scenario",
    ...
    # Conversion GWh/d to MWh/h
    pipe_capacities_list["p_nom"] = pipe_capacities_list[2037] * (1000 / 24)
    ...
    # Add missing columns
    c = {"scn_name": "nep2037_2025", "carrier": "CH4", "p_min_pu": -1.0}
    Neighbouring_pipe_capacities_list = (
...
def tyndp_gas_demand():
    """Insert gas demands abroad for nep2037_2025

    Insert CH4 and H2 demands abroad for nep2037_2025 by executing the
    following steps:
      * CH4
...
def grid():
    ...
    insert_gas_grid_capacities(
        Neighbouring_pipe_capacities_list, scn_name="nep2037_2025"
    )


def calculate_ocgt_capacities():
    """Calculate gas turbine capacities abroad for nep2037_2025

    Calculate gas turbine capacities abroad for nep2037_2025 based on TYNDP
...
def insert_ocgt_abroad():
    """Insert gas turbine capacities abroad for nep2037_2025 in the database
