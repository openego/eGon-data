...
Netzentwicklungsplan 2037, Version 2025, Szenario C
"""
...
class NEP2025ConvPowerPlants(Base):
    __tablename__ = "nep_2025_conventional_powerplants"
    __table_args__ = {"schema": "supply"}
    ...
    capacity = Column(Float)
    a2037_chp = Column(String(12))
    a2037_capacity = Column(Float)
    b2037_chp = Column(String(12))
    b2037_capacity = Column(Float)
    c2037_chp = Column(String(12))
    c2037_capacity = Column(Float)
    b2045_chp = Column(String(12))
    b2045_capacity = Column(Float)
...
def create_table():
    ...
    NEP2025ConvPowerPlantsonvPowerPlants.__table__.drop(bind=engine, checkfirst=True)
...
def insert_capacities_per_federal_state_nep():
    ...
    NEP 2037 (version 2025), scenario 2037 C
    ...
    db.execute_sql(
        ...
        {targets['scenario_capacities']['schema']}.
        {targets['scenario_capacities']['table']}
        WHERE scenario_name = 'nep2037_2025'
        AND nuts != 'DE'
        """
    )
    ...
    target_file = (
        ...
        / "nep2037_version2025"
        / sources["nep2037_2025"]["capacities"]
    )
    ...
    for bl in map_nuts.index:
        ...
        data["scenario_name"] = "nep2037_2025"
...
def aggr_nep_capacities(carriers):
    ...
    nep_capacities = insert_nep_list_powerplants(export=False)[
        ["federal_state", "carrier", "c2037_capacity"]
    ]

    # Sum up capacities per federal state and carrier
    capacities_list = (
        nep_capacities.groupby(["federal_state", "carrier"])["c2037_capacity"]
        .sum()
        .to_frame()
        .reset_index()
    )
...
def insert_nep_list_powerplants(export=True):
    ...
    target_file = (
        ...
        / "data_bundle_egon_data"
        / "nep2037_version2025"
        / sources["nep2037_2025"]["list_conv_pp"]
    )
    ...
    kw_liste_nep = kw_liste_nep.rename(
        columns={
            ...
            "Status": "status",
            "el. Leistung\n06.02.2020": "capacity",
            "A 2037:\nKWK-Ersatz": "a2037_chp",
            "A 2037:\nLeistung": "a2037_capacity",
            "B 2037\nKWK-Ersatz": "b2037_chp",
            "B 2037:\nLeistung": "b2037_capacity",
            "C 2037:\nKWK-Ersatz": "c2037_chp",
            "C 2037:\nLeistung": "c2037_capacity",
            "B 2045:\nKWK-Ersatz": "b2045_chp",
            "B 2045:\nLeistung": "b2045_capacity",
        }
    )
...
def insert_data_nep():
    """Overall function for importing scenario input data for nep2037_2025 scenario
...
if status_quo or ("nep2037_2025" in scenarios):
...
class ScenarioCapacities(Dataset):
    ...
    This data is coming from external sources (e.g. German grid developement plan for scenario nep2037_2025).
    ...
    *Resulting tables*
      ...
      * :py:class:`supply.egon_nep_2025_conventional_powerplants
      <egon.data.datasets.scenario_capacities.NEP2025ConvPowerPlants>` is created and filled
