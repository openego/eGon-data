...
def download_and_preprocess():
    ...
    pandas.DataFrame
        RegioStaR7 data
    """
    mit_sources = MotorizedIndividualTravel.sources.original_data["original_data"]["sources"]
...
class MotorizedIndividualTravel(Dataset):
    ...
    *emobility_mit*.
    ...
    # Attach original_data to sources
    sources.original_data = original_data
    ...
    def __init__(self, dependencies):
        def generate_model_data_tasks(scenario_name):
            ...
            mit_original_data = MotorizedIndividualTravel.sources.original_data
