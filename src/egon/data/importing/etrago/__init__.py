...
def create_tables():
    ...
    EgonPfHvBus.__table__.drop(bind=engine)
    EgonPfHvBusTimeseries.__table__.drop(bind=engine)
    EgonPfHvGenerator.__table__.drop(bind=engine)
    EgonPfHvGeneratorTimeseries.__table__.drop(bind=engine)
    EgonPfHvLine.__table__.drop(bind=engine)
    EgonPfHvLineTimeseries.__table__.drop(bind=engine)
    EgonPfHvLink.__table__.drop(bind=engine)
    EgonPfHvLinkTimeseries.__table__.drop(bind=engine)
    EgonPfHvLoad.__table__.drop(bind=engine)
    EgonPfHvLoadTimeseries.__table__.drop(bind=engine)
    EgonPfHvCarrier.__table__.drop(bind=engine)
    EgonPfHvStorage.__table__.drop(bind=engine)
    EgonPfHvStorageTimeseries.__table__.drop(bind=engine)
    EgonPfHvStore.__table__.drop(bind=engine)
    EgonPfHvStoreTimeseries.__table__.drop(bind=engine)
    EgonPfHvTempResolution.__table__.drop(bind=engine)
    EgonPfHvTransformer.__table__.drop(bind=engine)
    EgonPfHvTransformerTimeseries.__table__.drop(bind=engine)
    # Create new tables
    EgonPfHvBus.__table__.create(bind=engine)
    EgonPfHvBusTimeseries.__table__.create(bind=engine)
    EgonPfHvGenerator.__table__.create(bind=engine)
    EgonPfHvGeneratorTimeseries.__table__.create(bind=engine)
    EgonPfHvLine.__table__.create(bind=engine)
    EgonPfHvLineTimeseries.__table__.create(bind=engine)
    EgonPfHvLink.__table__.create(bind=engine)
    EgonPfHvLinkTimeseries.__table__.create(bind=engine)
    EgonPfHvLoad.__table__.create(bind=engine)
    EgonPfHvLoadTimeseries.__table__.create(bind=engine)
    EgonPfHvCarrier.__table__.create(bind=engine)
    EgonPfHvStorage.__table__.create(bind=engine)
    EgonPfHvStorageTimeseries.__table__.create(bind=engine)
    EgonPfHvStore.__table__.create(bind=engine)
    EgonPfHvStoreTimeseries.__table__.create(bind=engine)
    EgonPfHvTempResolution.__table__.create(bind=engine)
    EgonPfHvTransformer.__table__.create(bind=engine)
    EgonPfHvTransformerTimeseries.__table__.create(bind=engine)
