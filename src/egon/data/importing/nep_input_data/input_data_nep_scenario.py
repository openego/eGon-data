...
def manipulate_federal_state_numbers(df, carrier, scn = 'C 2035'):
    ...
    df_g = pd.read_csv('NEP_2021_Genehmiging_C2035.csv',
                       delimiter=';', decimal=',',
                       index_col='Unnamed: 0')
...
def insert_capacities_per_federal_state_nep():
    ...
    df = pd.read_csv('NEP_2021_C2035.csv',
                     delimiter=';', decimal=',',
                     index_col='Unnamed: 0')
...
def insert_nep_list_powerplants():
    ...
    kw_liste_nep = pd.read_csv('Kraftwerksliste_NEP_2021_konv.csv',
                               delimiter=';', decimal=',')
...
def district_heating_input():
    ...
    file = 'NEP_2021_C2035_district_heating.csv'
