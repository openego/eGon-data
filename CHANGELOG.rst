...
* Create new scenario status2019
  `#2_powerd-data <https://github.com/openego/powerd-data/issues/2>`_
  `#3_powerd-data <https://github.com/openego/powerd-data/issues/3>`_
  `#4_powerd-data <https://github.com/openego/powerd-data/issues/4>`_
  `#5_powerd-data <https://github.com/openego/powerd-data/issues/5>`_
  `#6_powerd-data <https://github.com/openego/powerd-data/issues/6>`_
  `#7_powerd-data <https://github.com/openego/powerd-data/issues/7>`_
  `#8_powerd-data <https://github.com/openego/powerd-data/issues/8>`_
  `#9_powerd-data <https://github.com/openego/powerd-data/issues/9>`_
  `#11_powerd-data <https://github.com/openego/powerd-data/issues/11>`_
  `#19_powerd-data <https://github.com/openego/powerd-data/issues/19>`_
  `#23_powerd-data <https://github.com/openego/powerd-data/issues/23>`_
  `#25_powerd-data <https://github.com/openego/powerd-data/issues/25>`_
  `#26_powerd-data <https://github.com/openego/powerd-data/issues/26>`_
  `#30_powerd-data <https://github.com/openego/powerd-data/issues/30>`_
  `#31_powerd-data <https://github.com/openego/powerd-data/issues/31>`_
  `#32_powerd-data <https://github.com/openego/powerd-data/issues/32>`_
  `#34_powerd-data <https://github.com/openego/powerd-data/issues/34>`_
  `#38_powerd-data <https://github.com/openego/powerd-data/issues/38>`_
  `#39_powerd-data <https://github.com/openego/powerd-data/issues/39>`_
  `#41_powerd-data <https://github.com/openego/powerd-data/issues/41>`_
  `#46_powerd-data <https://github.com/openego/powerd-data/issues/46>`_
  `#56_powerd-data <https://github.com/openego/powerd-data/issues/56>`_
  `#60_powerd-data <https://github.com/openego/powerd-data/issues/60>`_
  `#99_powerd-data <https://github.com/openego/powerd-data/issues/99>`_
  `#11_powerd-data4 <https://github.com/openego/powerd-data/issues/114>`_
  `#21_powerd-data3 <https://github.com/openego/powerd-data/issues/213>`_
* Make it possible to execute selected scenarios
  `#15_powerd-data <https://github.com/openego/powerd-data/issues/15>`_
* Include H2 grid
  `#254_powerd-data <https://github.com/openego/powerd-data/issues/254>`_
  `#333_powerd-data <https://github.com/openego/powerd-data/issues/333>`_
  `#334_powerd-data <https://github.com/openego/powerd-data/issues/334>`_
  `#336_powerd-data <https://github.com/openego/powerd-data/issues/336>`_
  `#355_powerd-data <https://github.com/openego/powerd-data/issues/355>`_
  `#366_powerd-data <https://github.com/openego/powerd-data/issues/366>`_
* Finish scenario eGon100RE
  ...
  `#274_powerd-data <https://github.com/openego/powerd-data/pull/274>`_
  `#273_powerd-data <https://github.com/openego/powerd-data/pull/273>`_
  `#271_powerd-data <https://github.com/openego/powerd-data/pull/271>`_
  `#268_powerd-data <https://github.com/openego/powerd-data/pull/268>`_
  `#267_powerd-data <https://github.com/openego/powerd-data/pull/267>`_
  `#265_powerd-data <https://github.com/openego/powerd-data/pull/265>`_
  `#264_powerd-data <https://github.com/openego/powerd-data/pull/264>`_
  `#256_powerd-data <https://github.com/openego/powerd-data/pull/256>`_
  `#255_powerd-data <https://github.com/openego/powerd-data/pull/255>`_
  `#254_powerd-data <https://github.com/openego/powerd-data/pull/254>`_
  `#252_powerd-data <https://github.com/openego/powerd-data/pull/252>`_
  `#274_powerd-data <https://github.com/openego/powerd-data/pull/274>`_
  `#245_powerd-data <https://github.com/openego/powerd-data/pull/245>`_
  `#244_powerd-data <https://github.com/openego/powerd-data/pull/244>`_
  `#243_powerd-data <https://github.com/openego/powerd-data/pull/243>`_
  `#241_powerd-data <https://github.com/openego/powerd-data/pull/241>`_
  `#237_powerd-data <https://github.com/openego/powerd-data/pull/237>`_
...
* Update Apache Airflow version
  `#36_powerd-data <https://github.com/openego/powerd-data/issues/36>`_
* Python 3.7 is not supported any more
  `#118_powerd-data <https://github.com/openego/powerd-data/issues/118>`_
* update OSM version to 2023
  `#167_powerd-data <https://github.com/openego/powerd-data/issues/167>`_
* update MaStR version to 2023
  `#172_powerd-data <https://github.com/openego/powerd-data/issues/172>`_
* Update data-bundle
  `#315_powerd-data <https://github.com/openego/powerd-data/pull/315>`_
...
* Fix entsoe-py dependency problems
  `#116_powerd-data <https://github.com/openego/powerd-data/issues/116>`_
* Fix lines with resistance = 0
  `#120_powerd-data <https://github.com/openego/powerd-data/issues/120>`_
* Fix uncompatibilities with new Pandas versions >2.0.0
  `#124_powerd-data <https://github.com/openego/powerd-data/issues/124>`_
  `#160_powerd-data <https://github.com/openego/powerd-data/issues/160>`_
* Fix unavailability of demand-regio with a provisional workaround
  `#180_powerd-data <https://github.com/openego/powerd-data/issues/180>`_
